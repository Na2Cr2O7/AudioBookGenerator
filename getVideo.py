...
def createVideo(textsCenter:list,textsBottom:list,audioFiles:list,output:str,size=(1920,1080),fontPath=r"../AlibabaPuHuiTi-3-55-Regular.ttf")->None:
    # 背景图片
    global thread        
    bgImage(size=size)
    ...
    clean([f'{i}.wav' for i in range(len(audioFiles)+1)]+[f'{output}temp.mp4',"temp_audio.mp3"])
